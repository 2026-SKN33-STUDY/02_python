...
print("append 후 lst id: ", id(lst))     # id가 동일
print("append 전후 같은 list인가? ", before_id == id(lst))    # True

# list.insert(index, literal)
# - index에 값을 삽입하는 메서드
...
data = "홍길동, 20, 서울시, 서초구"
data_ = data.split(",")
print("data_: ", data_, type(data_))    # list로 반환
...
print(name, age, addr1, addr2, type(name), type(age), type(addr1), type(addr2))
...
print(texts)
print(texts[:2])
texts[:2] = ["aaa", "bbb"]      # 좌항과 우항의 개수가 같아야 함
print(texts)
texts[1:3] = ["😎😎😎", "👌👌👌"]
print(texts)
